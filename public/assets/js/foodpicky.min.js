$(document).ready(function () {
    ...
    var a = document.querySelector("#header"), e = new Headroom(a, {
        offset: 80,
        tolerance: 40,
        classes: {initial: "animated", pinned: "fadeInDown", unpinned: "fadeOutUp"}
    });
    e.init(), e.init();
    ...
    t.click(function () {
        ...
        var a = $(this), e = a.parent().find("input"), n = parseInt(e.val()), i = n + 1;
        e.val(i)
